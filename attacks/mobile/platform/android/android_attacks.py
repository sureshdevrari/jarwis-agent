...
class AndroidVulnerability:
    """Represents an Android-specific vulnerability with comprehensive metadata"""
    id: str
    ...
    def enrich_from_registry(self) -> 'AndroidVulnerability':
        """
        ...
        category_mapping = {
            ...
            "content_provider": "intent_injection",
            "webview": "webview_vulnerability",
            "broadcast": "intent_injection",
            "backup": "backup_data_exposure",
            "debuggable": "debuggable_application",
            "root_detection": "root_jailbreak_detection_bypass",
            "tapjacking": "binary_protection",
            "task_hijacking": "intent_injection",
