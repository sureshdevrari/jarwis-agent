"""Test web scanning without MITM proxy - for debugging"""
import asyncio
import logging
import sys
import traceback
...
async def test():
    ...
    print('='*60, flush=True)
    print('Testing scan WITHOUT MITM proxy (simple mode)...', flush=True)
    print('='*60, flush=True)
