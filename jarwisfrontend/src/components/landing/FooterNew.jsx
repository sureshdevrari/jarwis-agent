// src/components/landing/FooterNew.jsx
// Devin.ai-inspired footer with clean minimal design
...
const FooterNew = () => {
  ...
  const footerLinks = {
    ...
    legal: [
      ...
      { name: "Refund Policy", path: "/refund&return" },
    ],
  };
    ...
    <footer className="relative z-20 backdrop-blur-xl border-t border-gray-600 mt-4 bg-gray-950">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 md:gap-8">
            ...
            <div className="flex items-center space-x-4">
              {socialLinks.map((social) => (
                <a
                  ...
                  className={`w-10 h-10 bg-gray-800 ${social.hoverClass} rounded-full flex items-center justify-center transition-all duration-300 group`}
          ...
          {/* Platform links */}
          <div>
            <h4 className="text-white font-bold mb-4 md:mb-6 text-base md:text-lg">Platform</h4>
          ...
          {/* Company & Legal links */}
          <div>
            <h4 className="text-white font-bold mb-4 md:mb-6 text-base md:text-lg">Company</h4>
            <ul className="space-y-2 md:space-y-3 text-gray-400 text-sm md:text-base">
        ...
        <div className="border-t border-gray-800 mt-8 md:mt-12 pt-6 md:pt-8 text-center">
          <p className="text-gray-400 text-xs md:text-sm">
            (C) {currentYear} Jarwis AGI. Created by BKD Labs
          </p>
        </div>
      </div>
    </footer>
